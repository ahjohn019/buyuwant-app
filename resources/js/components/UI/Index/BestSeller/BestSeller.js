                                ...
                                <div className="h-full flex flex-col items-center w-full mx-auto">
                                    ...
                                    <div className="p-4 w-full ">
                                        ...
                                        <div className="p-4 flex justify-center">
                                            <Link
                                                to={{
                                                    pathname: `/items_details/${response.tag_one_item.id}`
                                                }}
                                            >
                                                <button
                                                    className="product-grid-btn bg-blue-400 hover:bg-blue-600 w-24 h-8 uppercase font-bold text-white rounded-lg text-sm shadow-lg"
                                                    type="submit"
                                                >
                                                    view
                                                </button>
                                            ...
                                            <button
                                                ...
                                                className="product-grid-btn bg-green-400 hover:bg-green-600 w-24 h-8 uppercase font-bold text-white rounded-lg text-sm shadow-lg"
                                                type="submit"
                                            >
                                                add
                                            </button>
