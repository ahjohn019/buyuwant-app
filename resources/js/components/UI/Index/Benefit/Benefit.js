                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-8">
                    <div className="w-full border rounded-lg shadow-md p-4 flex flex-col">
                        ...
                        <div className="flex flex-col m-8">
                            ...
                            <p className="mt-4">No matter how far you are, we will always deliver things on time.</p>
                        </div>
                    </div>
                    <div className="w-full border rounded-lg shadow-md p-4 flex flex-col">
                        <div className="flex justify-center items-center ">
                        ...
                        <div className="flex flex-col m-8">
                            ...
                            <p className="mt-4">We will ensure all the item is safe and good to use.</p>   
                        </div> 
                    </div>
                    <div className="w-full border rounded-lg shadow-md p-4 flex flex-col">
                        <div className="flex justify-center items-center ">
                        ...
                        <div className="flex flex-col m-8">
                            ...
                            <p className="mt-4">our product is 100% original, directly from factory made.</p>
                        </div>
                    </div>
                    <div className="w-full border rounded-lg shadow-md p-4 flex flex-col">
                        <div className="flex justify-center items-center ">
                        ...
                        <div className="flex flex-col m-8">
                            ...
                            <p className="mt-4">items is direct from our factory made, cost will be cheaper than others marketplace.</p>
                        </div>
                    </div>
                </div>
            </div>
