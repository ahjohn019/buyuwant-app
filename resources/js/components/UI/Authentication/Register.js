...
const Register = () => {
    ...
    const onRegisterSubmit = async () => {
        try {
            ...
            setRegErrorEmail(error.response.data.email);
            setRegErrorPhone(error.response.data.phone_number);
            setRegErrorPwd(error.response.data.password);
        }
    };
    return (
        <div>
