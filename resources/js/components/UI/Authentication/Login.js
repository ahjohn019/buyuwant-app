    ...
    return (
        <div>
            ...
            <div className="mt-24 mb-6 flex flex-col items-center ">
                            ...
                            <div className="flex">
                                ...
                                <div>
                                    <p className="font-light">
                                        Reset password has been sent to your
                                        email successfully.
                                    </p>
                                </div>
                            </div>
                ...
                <h2 className="text-center text-4xl tracking-tight">
            ...
            <div className="w-full max-w-xl m-auto ">
                <form
                    ...
                    className="shadow-md rounded p-8 m-6 bg-gray-200"
                >
                    <div className="mb-4">
                        <label
                        ...
                        <input
                            ...
                            type="email"
                            placeholder="Email"
                            className="shadow appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none"
                            required
                        ></input>
                    </div>
                    <div className="mb-6">
