...
export default function addUserAddress(prop) {
    ...
    return (
        <div>
            <button
                className="bg-blue-200 hover:bg-blue-500 w-36 h-10 rounded-lg uppercase"
                type="submit"
            ...
            >
                <Box
                    className="absolute top-1/2 left-1/2 bg-white p-8 w-3/4 md:w-auto"
                    ...
                    <form className="w-full max-w-lg" onSubmit={addressSubmit}>
                        <div className="flex flex-wrap -mx-6 mb-6">
                            <div className="w-full px-3 mb-6 md:mb-0">
                                ...
                                <input
                                    onChange={onRegisterAddress("address_line")}
                            ...
                            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input
                                    onChange={onRegisterAddress("postcode")}
                                    className="block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                    id="address-postcode"
                                    type="text"
                            ...
                            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <div className="relative">
                                    <select
                                        onChange={onRegisterAddress("state")}
                                        className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                        id="address-state"
                                    >
                                        <option
                                            onChange={onRegisterAddress(
                                                "state"
                                            )}
                                            value="Johor"
                                        >
                            ...
                            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <div className="relative">
                                    <select
                                        onChange={onRegisterAddress("country")}
                                        className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                        id="address-state"
                                    >
                                        <option
                            ...
                            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input
                                    onChange={onRegisterAddress("phone_number")}
                                    className="block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                    id="address-phonenum"
                                    type="text"
